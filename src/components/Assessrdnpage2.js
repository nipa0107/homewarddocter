...
export default function Assessreadiness2({ }) {
                    ...
                    <form>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question1"
                                        value="ถูกต้อง"
                                        checked={formData.question1 === 'ถูกต้อง'}
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question1"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question1 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question2"
                                        value="ถูกต้อง"
                                        checked={formData.question2 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question2"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question2 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question3"
                                        value="ถูกต้อง"
                                        checked={formData.question3 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question3"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question3 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question4"
                                        value="ถูกต้อง"
                                        checked={formData.question4 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question4"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question4 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question5"
                                        value="ถูกต้อง"
                                        checked={formData.question5 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question5"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question5 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question6"
                                        value="ถูกต้อง"
                                        checked={formData.question6 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question6"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question6 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question7"
                                        value="ถูกต้อง"
                                        checked={formData.question7 === 'ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ถูกต้อง
                                </label>
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        name="question7"
                                        value="ไม่ถูกต้อง"
                                        checked={formData.question7 === 'ไม่ถูกต้อง'}
                                        onChange={handleChange}
                                    />
                                    ไม่ถูกต้อง
                                </label>
                        ...
                        <div className="btn-group">
                            <div className="btn-pre">
                                <button type="button" onClick={handlePrevious} className="btn btn-outline py-2">
                                    ก่อนหน้า
                                </button>
                            </div>
                            <div className="btn-next">
                                <button type="button" onClick={handleSave} className="btn btn-outline py-2">
                                    บันทึก
                                </button>
                            </div>
                        </div>
